...
void init(GLFWwindow *window)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, RAYTRACE_RENDER_WIDTH, RAYTRACE_RENDER_HEIGHT, 0, GL_RGBA, GL_UNSIGNED_BYTE, (const void *)screenTexture); //
	...
	/*
	 */
	raytraceComputeShader = Utils::createShaderProgram("assets/shaders/raytraceComputeShader.glsl");
	screenQuadShader = Utils::createShaderProgram("assets/shaders/vertShader.glsl", "assets/shaders/fragShader.glsl");

	brickTexture = Utils::loadTexture("assets/images/brick1.jpg");
	// earthTexture = Utils::loadTexture("assets/images/earthmap1k.jpg");
	earthTexture = Utils::loadTexture("assets/images/earth.jpg"); //
	xpTex = Utils::loadTexture("assets/images/cubeMap/xp.jpg");
	xnTex = Utils::loadTexture("assets/images/cubeMap/xn.jpg");
	ypTex = Utils::loadTexture("assets/images/cubeMap/yp.jpg");
	ynTex = Utils::loadTexture("assets/images/cubeMap/yn.jpg");
	zpTex = Utils::loadTexture("assets/images/cubeMap/zp.jpg");
	znTex = Utils::loadTexture("assets/images/cubeMap/zn.jpg");
}
...
int main(void)
{
	...
	GLFWwindow *window = glfwCreateWindow(windowWidth, windowHeight, "Lab6: Ray Tracing", NULL, NULL); //
